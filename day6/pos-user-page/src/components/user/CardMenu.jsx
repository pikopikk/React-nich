...
export default function CardMenu({title, image, price, isBest = false, isSignature = false, className = ''}){
  return(
    <div className={ `mt-2 ease-out duration-300 hover:scale-105 w-36 min-h-58 ${className}`}>
...
function UserIconCart(){
  return(
    <button 
      className="bg-stone-900/60 p-1 rounded-2xl absolute top-2 right-2 w-fit h-fit ease-in duration-200 hover:scale-110">
